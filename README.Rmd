...
In practical terms, this means that this version of vegawidget will be the *only* CRAN version that will display properly using version 1.1.x of the RStudio IDE. 

As soon as Vega-Lite makes its 3.0.0 release, we will make another vegawidget release on CRAN - for which you will need to use a (presently preview) version of the RStudio IDE at least 1.2.x.
