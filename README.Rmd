...
To be clear, although Vega-Lite offers a grammar-of-graphics, this package is not designed as a primary tool to compose graphics (composing using `list()` can be tedious). However, this package may be useful to:
...
- develop higher-level, user-friendly packages to build specific types of plots, or even to build a general ggplot2-like framework, using this package as a foundation.
