...
- [Alicia Schep](https://github.com/AliciaSchep) has been instrumental in guiding the API
- [Bob Rudis](https://github.com/hrbrmstr) and the [vegalite](https://github.com/hrbrmstr/vegalite) package provided a lot of the initial inspiration
