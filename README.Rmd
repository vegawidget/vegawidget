...
- [Share with bl.ocks.org](https://vegawidget.github.io/vegawidget/articles/blocks.html): using GitHub, you can deploy and retrieve vegaspecs to/from [bl.ocks.org](https://bl.ocks.org). 
