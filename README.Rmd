...
The *first* CRAN version of vegawidget supports Vega-Lite 2.6.0, the *last* release of Vega-Lite that will run using JavaScript version ES5. The next version of Vega-Lite, 3.0.0, will use JavaScript ES6. 
...
This development version of vegawidget uses a release-candidate version of Vega-Lite 3.0.0. The *next* CRAN release of vegawidget will be made shortly after the Vega-Lite team make their offical 3.0.0 release.
