...
- vegawidget offers Vega-Lite `r vegawidget::vega_version()$vega_lite` and Vega `r vegawidget::vega_version()$vega`. 
...
```{r gh-installation-vl5, eval=FALSE}
# install.packages("devtools")
devtools::install_github("vegawidget/vegawidget@vegalite-5")
```

This is an experimental feature-branch, but we'll do our best to keep it stable.
