...
This development version of vegawidget uses a release-candidate version
of Vega-Lite 3.0.0. The *next* CRAN release of vegawidget will be made
shortly after the Vega-Lite team make their offical 3.0.0 release.
