...
We are going to overlay this with a data frame to support multiple versions.
...
This bit seems troublesome - perhaps we can just get rid of it? 
For the moment, I am going to pretend it does not exist :)
