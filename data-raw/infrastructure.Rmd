...
- internal package data: 
  ...
  - strings of minified javascript libraries: `.vega_js`, `.vega_polyfill_symbol_js`, `.vega_polyfill_promise_js`, `.vega_lite_js` (perhaps the js libraries could use the htmldependency and memoise)
- public package data:
...
This is a patch to get the "latest" version of vega-embed. Once we move to Vega-Lite 3, this code should be removed.
