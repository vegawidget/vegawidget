...
Next, we define our data-ouput and the data-handler. For the output, we provide an `id`, `"output-data"`, to identify where in this document to write the data. Our handler function the data set to it, convert it to JSON (with a little formatting), then put the JSON string into our output element named `"output-data"`. 
