...
If you are working with time-based data, this mismatch of capabilities introduces a lot of "opportunities" to create a Vega(-Lite) visualizations that do not behave as intended. The purposes of this article are 
