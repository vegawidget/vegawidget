...
- getting [events](#events), including a [demo](#demo-event)
- setting and getting [signals](#signals), including a [demo](#demo-signals)
- setting (and soon getting) [data](#data), including a [demo]() 
...
We use the `vegawidget()` function with an `elementId` argument, to specify the id of the HTML element containing the chart. We need to specify this so that the JavaScript code we supply will know which Vega chart to modify. 
