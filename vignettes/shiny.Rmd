...
This is a shortened version of the [events section](javascript.html#events) in the [JavaScript article](JavaScript); the concepts are the same, but the implementation is far simpler using Shiny. 
...
The Shiny demo, `vw_shiny_demo("event-get")`, features a scatterplot. When a mark on the chart is clicked, it returns to Shiny the data observation (datum) associated with that mark.
...
To see the same logic implemented in pure JavaScript, see the [events section](javascript.html#events) of the JavaScript article.
...
To see the same logic implemented in pure JavaScript, see the [signals section](javascript.html#signals) of the JavaScript article.
...
To see the same logic implemented in pure JavaScript, see the [data section](javascript.html#signals) of the JavaScript article.
