...
vw_write_svg(vw_ex_mtcars, path = file_svg)
...
vw_write_svg(vw_ex_mtcars, path = file_svg, width = 600, height = 300)
...
vw_write_svg(vw_ex_mtcars, path = file_svg, scale = 2)
...
vw_write_svg(vegawidget(vw_ex_mtcars), path = file_svg)
